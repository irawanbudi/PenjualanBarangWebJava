 ...
 * @author Irawan
 */
@WebServlet(name = "Deskripsi", urlPatterns = {"/Deskripsi"})
public class Deskripsi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String konten;
        konten="<h2>Aplikasi Penjualan - Web</h2>"
                + "By 05TPLEN Team 2016:<br>"
                + "Amarullah<br>"
                + "Chandra Irwansyah<br>"
                + "Handrian Maulana<br>"
